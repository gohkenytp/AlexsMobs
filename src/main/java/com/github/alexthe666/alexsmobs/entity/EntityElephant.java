...
public class EntityElephant extends TameableEntity implements ITargetsDroppedItems, IAnimatedEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(9, new AvoidEntityGoal<>(this, EntityFly.class, 6.0F, 1.0D, 1.2D));
        this.goalSelector.addGoal(10, new EntityElephant.AIWalkIdle(this, 0.5D));
